...
# ====================== QR CODE GENERATOR ======================
def generate_qr(amount, number, ref, method):
    if method == "bkash":
        qr_data = f"bkash://pay?amount={amount}&merchant={number}&ref={ref}"
    else:
        qr_data = f"nagad://pay?amount={amount}&merchant={number}&ref={ref}"
    ...
    if method == "bkash":
        ...
        img = qr.make_image(fill_color="#F5A623", back_color="white")
...
if not products:
    products = {
        "1": {
            ...
            "price": 399,
            "keys": ["DRIP-PRO-001", "DRIP-PRO-002", "DRIP-PRO-003"],
            "stock": 50,
            "desc": "✨ প্রিমিয়াম গেমিং মড\n✅ নন-রুট সাপোর্ট\n✅ ৩০ দিন এক্সেস\n✅ অটো আপডেট\n✅ অ্যান্টি-ব্যান"
        },
        "2": {
            "name": "🎮 BGMI ESP HACK",
            "price": 299,
            "keys": ["BGMI-ESP-001", "BGMI-ESP-002"],
            "stock": 30,
            "desc": "✨ ইএসপি + এইমবট\n✅ ১০০% সেফ\n✅ আনডিটেক্টেড\n✅ স্মুথ গেমপ্লে"
        },
        "3": {
...
def start(m):
    ...
    if uid not in users:
        ...
        add_balance(uid, 50, "🎁 সাইনআপ বোনাস")
    ...
    if len(m.text.split()) > 1:
        ...
        if ref_code.startswith("ref_"):
            ...
            if referrer != str(uid) and users.get(referrer):
                ...
                add_balance(referrer, 50, "🔗 রেফারেল বোনাস")
                save_db('users.json', users)
                bot.send_message(int(referrer), f"🎉 **নতুন রেফারেল!**\n\n{m.from_user.first_name} আপনার লিংক ব্যবহার করে জয়েন করেছেন!\n💰 ৳৫০ বোনাস যোগ করা হয়েছে!")
...
def shop(c):
    ...
    for pid, p in products.items():
        ...
        m.add(InlineKeyboardButton(f"{stock_icon} **{p['name']}** - ৳{p['price']}", callback_data=f"prod_{pid}"))
    ...
    bot.edit_message_caption(
        ...
        "║        🛍️ 𝗦𝗘𝗟𝗘𝗖𝗧 𝗣𝗥𝗢𝗗𝗨𝗖𝗧         ║\n"
        "╚══════════════════════════════════════╝\n\n"
        "📦 **নিচ থেকে আপনার পছন্দের প্রোডাক্ট সিলেক্ট করুন:**\n",
...
def manual_pay(c):
    ...
    # Generate QR Code
    qr_img = generate_qr(pend['price'], number, ref, "bkash" if c.data == "pay_bkash" else "nagad")
...
1️⃣ **𝗦𝗰𝗮𝗻 𝘁𝗵𝗲 𝗤𝗥 𝗰𝗼𝗱𝗲** 𝗯𝗲𝗹𝗼𝘄
2️⃣ **𝗦𝗲𝗻𝗱 ৳{pend['price']}** 𝘁𝗼 {number}
3️⃣ **𝗦𝗲𝗻𝗱 𝗧𝗥𝗫 𝗜𝗗** 𝗵𝗲𝗿𝗲
4️⃣ **𝗦𝗲𝗻𝗱 𝗽𝗮𝘆𝗺𝗲𝗻𝘁 𝘀𝗰𝗿𝗲𝗲𝗻𝘀𝗵𝗼𝘁**
...
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━"""
    ...
    bot.send_photo(c.message.chat.id, qr_img, caption=text, reply_markup=m, parse_mode="Markdown")
...
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━"""
    ...
    markup.add(
        InlineKeyboardButton("✅ 𝗔𝗣𝗣𝗥𝗢𝗩𝗘", callback_data=f"app_{uid}_{pend['pid']}"),
        InlineKeyboardButton("❌ 𝗥𝗘𝗝𝗘𝗖𝗧", callback_data=f"rej_{uid}")
    )
...
"""
    ...
    m = InlineKeyboardMarkup()
    m.add(InlineKeyboardButton("➕ 𝗔𝗗𝗗 𝗕𝗔𝗟𝗔𝗡𝗖𝗘", callback_data="add_balance"))
    m.add(InlineKeyboardButton("🏠 𝗛𝗢𝗠𝗘", callback_data="home"))
...
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━"""
        ...
        markup.add(
            ...
            InlineKeyboardButton("❌ 𝗥𝗘𝗝𝗘𝗖𝗧", callback_data=f"rej_{m.chat.id}")
        )
...
if __name__ == "__main__":
    print("=" * 60)
    print("🔥 𝗔𝗡𝗧𝗢 𝗦𝗛𝗢𝗣 𝗨𝗟𝗧𝗜𝗠𝗔𝗧𝗘 𝗣𝗥𝗢 𝗘𝗗𝗜𝗧𝗜𝗢𝗡 𝗦𝗧𝗔𝗥𝗧𝗘𝗗!")
